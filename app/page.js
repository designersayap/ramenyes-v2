...
export default function ExportedPage() {
  return (
    <main style={{ position: 'relative', minHeight: '100vh', width: '100%', overflowX: 'clip', containerType: 'inline-size', containerName: 'root-container' }}>
      ...
      <OsmBanner
        title={"Waspada penipuan! Pemenang tidak dipungut biaya apa pun dan hanya akan dihubungi melalui <b>WhatsApp Resmi <a href=\"https://wa.me/6281119751441\">08111-975-1441</a></b><a href=\"https://wa.me/6281119751441\"> </a>atau <b>WINGS Customer Care +62 21 50957907</b>."}
        buttonText={"Label"}
        buttonUrl={""}
        buttonVisible={false}
        buttonLinkType={"url"}
      ...
      />
      <Media54
        image={"https://space.lunaaar.site/assets-ramenyes/headline_5_4.webp"}
        imageUrl={""}
        imageLinkType={"url"}
        imageTargetDialogId={""}
        fullWidth={false}
      ...
      />
      <Media169
        image={"https://space.lunaaar.site/assets-ramenyes/TVC%20Ramen%20YES.webm"}
        imageUrl={""}
        imageLinkType={"url"}
        imageTargetDialogId={""}
        fullWidth={false}
